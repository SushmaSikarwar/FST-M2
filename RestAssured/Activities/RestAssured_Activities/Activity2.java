...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws IOException {
        ...
        response.then().body("message", equalTo("1902"));
    }
    ...
    public void getUserInfo() {
        ...
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "Sika") // Pass request body from file
        ...
        // Assertion
        response.then().body("id", equalTo(1902));
        response.then().body("username", equalTo("Sika"));
    ...
    public void deleteUser() throws IOException {
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "Sika") // Add path parameter
                        .when().delete(ROOT_URI + "/{username}"); // Send POST request

        // Assertion
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("Sika"));
    }
}
